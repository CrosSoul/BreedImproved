...
The initial release of Breed Improved adds **Exile from Dynasty**, a player-initiated Character Interaction for moving one eligible Dynasty member and their descendants into a replacement Dynasty generated by CK3.
...
- Workshop item: https://steamcommunity.com/sharedfiles/filedetails/?id=3769010534
- Subscribe through Steam Workshop, enable **Breed Improved** in a CK3 Launcher playset, and launch the game.

The item URL is recorded for release preparation; this document does not claim that Workshop visibility has been changed to public.
